...
#[derive(Debug)]
pub struct NextMetaProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NextMetaProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NextMeta processing");
    
    let mut processor = NextMetaProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NextMetaProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NextMetaProcessor::new(false);
